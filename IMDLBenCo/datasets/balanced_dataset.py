...
class BalancedDataset(Dataset):
    ...
    def __init__(self, 
        ...
        if path == None:
            ...
            # self.settings_list = [
            #     ['/disk/csh/IMDLBenCo/CASIA_v2_manip.json', JsonDataset],
            #     ['/disk/csh/IMDLBenCo/FantasticReality_manip.json', JsonDataset],
            #     ['/disk/csh/IMDLBenCo/FantasticReality_auth.json', JsonDataset],
            #
            #     ['/disk/csh/IMDLBenCo/IMD2020.json', JsonDataset],
            #     ['/disk/csh/IMDLBenCo/sp_COCO.json', JsonDataset],
            #     ['/disk/csh/IMDLBenCo/cm_COCO.json', JsonDataset],
            #     ['/disk/csh/IMDLBenCo/bcm_COCO.json', JsonDataset],
            #     ['/disk/csh/IMDLBenCo/bcmc_COCO.json', JsonDataset]
            # ]
        else:
            import json
    ...
    def __getitem__(self, index):
        ...
        # print(index)
        # print(dataset_index*self.sample_number)
