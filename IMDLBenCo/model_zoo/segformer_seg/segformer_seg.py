...
from IMDLBenCo.model_zoo.segformer_seg.segformer_decoder import DecoderHead
...
class MixVisionTransformer(nn.Module):
    def __init__(self, input_head=None, num_channels=0, pretrain_path='', img_size=512, patch_size=4, in_chans=3,
...
def segformer_seg(pretrain_pth_path):
