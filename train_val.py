...
def main(args, model_args):
    ...
    dataset_test2 = JsonDataset(
        '/disk/csh/IMDLBenCo/val_data/alldata.json',
        is_padding=args.if_padding,
        is_resizing=args.if_resizing,
        output_size=(args.image_size, args.image_size),
        common_transforms=test_transform,
    ...
    if args.distributed:
        ...
        sampler_test2 = torch.utils.data.DistributedSampler(
            dataset_test2, num_replicas=num_tasks, rank=global_rank, shuffle=False, drop_last=True
        )
        ...
        sampler_test2 = torch.utils.data.RandomSampler(dataset_test2)
    ...
    # g = torch.Generator()
    # g.manual_seed(3407 + global_rank)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % args.test_period == 0 or epoch + 1 == args.epochs:
            ...
            test_stats2 = test_one_epoch(
                model,
                data_loader=data_loader_test2,
                evaluator_list=evaluator_list,
                device=device,
                epoch=epoch,
                log_writer=log_writer,
...
#-----
            ...
            log_stats =  {**{f'train_{k}': v for k, v in train_stats.items()},
                        ...
                        **{f'val_{k}': v for k, v in test_stats2.items()},
                            'epoch': epoch,}
        else:
