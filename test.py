...
from IMDLBenCo.evaluation import PixelF1, ImageF1, PixelAUC,PixeloptF1,PixelIOU
...
def main(args, model_args):
    ...
    evaluator_list = [
        ...
        # PixeloptF1(threshold=0.5, mode="double"),
        # PixelAUC(mode='double'),
        PixelIOU(mode='double'),
        PixelAUC(mode='double'),
        # PixelIOU(mode='origin'),
    ...
    for dataset_name, dataset_path in test_dataset_json.items():
        ...
        chkpt_pair.sort(key=lambda x: x[0],reverse=True)
